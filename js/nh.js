...
const COURSES = [
    {
        ...
        steps: [
            { 
                ...
                content: '<p>Hãy tìm một nơi yên tĩnh. Ngồi chéo chân (bán già hoặc kiết già) hoặc ngồi trên ghế.</p><ul><li><strong>Lưng:</strong> Giữ thẳng tự nhiên, không gồng cứng.</li><li><strong>Vai:</strong> Thả lỏng hoàn toàn.</li><li><strong>Tay:</strong> Đặt chồng lên nhau hoặc để trên đầu gối.</li><li><strong>Mắt:</strong> Khép hờ hoặc nhắm nhẹ.</li></ul><p><em>Hãy ngồi thử trong 2 phút để cảm nhận cơ thể.</em></p>' 
            },
            { 
                id: 's_2_breath', 
            ...
            { 
                id: 's_3_count', 
                title: 'Phương pháp đếm & Ghi nhận', 
                desc: 'Cách sử dụng ứng dụng để ghi nhận Chánh niệm qua hơi thở.', 
                content: '<p>Để tăng cường sự tập trung, bạn hãy phối hợp việc đếm thầm với việc ghi nhận trên ứng dụng:</p><ul><li><strong>Chạm (Tap):</strong> Mỗi khi thở ra và đếm xong một số, hãy chạm nhẹ vào màn hình. Việc này giúp tay và tâm đồng bộ.</li><li><strong>Mục tiêu:</strong> Duy trì sự ghi nhận liên tục không gián đoạn.</li></ul><p><em>Để hoàn thành bài học này, hãy thực hành một phiên ngắn 5 phút.</em></p>',
                practiceParams: { duration: 1 }
            },
            {
                id: 's_3_awareness',
                title: 'Ghi nhận Tỉnh giác',
                desc: 'Học cách nhận diện trạng thái tâm tỉnh táo, rõ ràng.',
                content: '<p>Tỉnh giác là khả năng biết rõ trạng thái của tâm. Trong ứng dụng, chúng ta ghi nhận sự <strong>Tỉnh giác</strong> bằng cách <strong>Nhấn và Giữ (Hold)</strong>:</p><ul><li>Khi bạn cảm thấy tâm mình đang rất sáng suốt, tĩnh lặng và bao quát được đề mục, hãy nhấn giữ vào màn hình cho đến khi thấy vòng tròn xanh (khiên bảo vệ) xuất hiện.</li><li>Việc này giúp đánh dấu các khoảnh khắc tâm có chất lượng định cao.</li></ul><p><strong>Yêu cầu hoàn thành:</strong> Thực hiện một thời thiền 10 phút với ít nhất 10 lần ghi nhận Tỉnh giác.</p>',
                practiceParams: { duration: 1, minAwareness: 1 }
            },
            {
                id: 's_3_confirm',
                title: 'Chế độ Xác nhận',
                desc: 'Rèn luyện sự trung thực và tỉnh táo tức thời.',
                content: '<p>Chế độ Xác nhận (Confirmation Mode) sẽ thỉnh thoảng yêu cầu bạn xác nhận lại ghi nhận vừa thực hiện để đảm bảo bạn không bấm máy móc.</p><ul><li><strong>Cách bật:</strong> Vào Cấu hình thiền (biểu tượng bánh răng) -> Bật "Chế độ xác nhận".</li><li>Khi có yêu cầu, bạn cần thực hiện đúng thao tác ứng dụng yêu cầu trong thời gian ngắn để được tính điểm.</li></ul><p><strong>Yêu cầu hoàn thành:</strong> Thời thiền 10 phút, Tỉnh giác > 10, Chánh niệm > 20 và phải bật Chế độ xác nhận.</p>',
                practiceParams: { duration: 1, minAwareness: 1, minMindfulness: 2, requireConfirmMode: true }
            },
			{
    id: 's_3_levels',
    title: 'Mức độ Chú tâm',
    desc: 'Phân loại chất lượng ghi nhận để rèn luyện sự tinh tế.',
    content: `
        <p>Không chỉ ghi nhận <em>khi nào</em> có chánh niệm, chúng ta còn ghi nhận <em>chất lượng</em> của nó bằng cách chạm nhiều lần:</p>
        <ul>
            <li><strong>Chạm 2 lần (Double Tap):</strong> Khi bạn thấy mức độ chú tâm ở mức <strong>Trung bình</strong> (rõ ràng nhưng chưa sâu).</li>
            <li><strong>Chạm 3 lần trở lên:</strong> Khi bạn thấy mức độ chú tâm <strong>Tốt</strong> (rất rõ rệt và vững vàng).</li>
            <li><strong>Chạm 1 lần:</strong> Mức chú tâm thấp (vừa nhận ra hơi thở sau khi phóng tâm).</li>
        </ul>
        <p>Việc phân loại giúp bạn nhận diện được sự vi tế của định tâm và tránh việc bấm máy móc.</p>
        <p><strong>Yêu cầu hoàn thành:</strong> Thời thiền 10 phút, có ít nhất 1 lần ghi nhận Trung bình và 1 lần ghi nhận Tốt.</p>
    `,
    practiceParams: { 
        duration: 1, 
        ...
        minGood: 1     // Yêu cầu ít nhất 1 lần Tốt (quality = 2)
			...
			{ 
                ...
                desc: 'Cam kết tu tập với mục tiêu Thiền Căn Bản 1.', 
                content: '<p>Bạn đã nắm vững lý thuyết. Bây giờ là lúc bước vào thực hành nghiêm túc.</p><p>Khi nhấn nút bên dưới, hệ thống sẽ tạo một Mục tiêu tu tập đặc biệt: <strong>Thiền Căn Bản 1</strong>.</p><ul><li><strong>Mục tiêu:</strong> Đạt 10,000 Chánh niệm.</li><li><strong>Kỷ luật:</strong> Không thể sửa đổi mục tiêu, không thể nhập thủ công.</li><li><strong>Tốt nghiệp:</strong> Sau khi hoàn thành chỉ tiêu, bạn phải vượt qua bài <strong>Thi Cuối Khoá (60 phút)</strong> để nhận Chứng Chỉ & Huy Hiệu.</li></ul>',
                isCertAction: true // Flag to render special button
            }
        ]
    },
...
enrollCertification() {
    const certId = 'cert_basic_1';
    
    // Check if exists
    if (this.data.goals.find(g => g.id === certId)) {
    ...
    const newGoal = {
        id: certId,
        type: 'meditation',
        name: 'Thiền Căn Bản 1',
        category: 'Niệm Hơi Thở',
        color: '#eab308', // Gold/Yellow
        
        // Locked Targets
        dailyTargetMinutes: 600, // Daily Mindfulness count target
        lifetimeTargetMinutes: 10000, // Total Mindfulness target
        dailySessionTarget: 8,
        dailyMinMedTarget: 60, // Minutes per day
    ...
    this.data.goals.unshift(newGoal); // Add to top
    this.save();
    this.renderGoals();
    this.showToast('Đã đăng ký: Khoá Chứng chỉ Thiền Căn Bản 1');
    
    // Close course view to show dashboard
    this.activeCourseId = null;
    this.renderRoadmap();
...
renderRoadmap() {
    ...
    renderCourseDetail(container, courseId) {
        ...
        header.innerHTML = `
            ...
            <div>
                ...
                <span style="font-size:12px; color:var(--text-light)">Lộ trình bài học</span>
            </div>
        `;
        ...
        if (step.isCertAction) {
            // Special Button for Certification
            const existingGoal = this.data.goals.find(g => g.id === 'cert_basic_1');
            if (existingGoal) {
                 ...
                 actionBtn.innerHTML = 'Tham gia Chương Trình';
                 actionBtn.onclick = (e) => {
                     e.stopPropagation();
                     this.enrollCertification();
                     this.toggleStepCompletion(courseId, step.id); // Mark step as read
                 };
            }
    ...
    actionBtn.onclick = (e) => {
        ...
        if (isCompleted) {
            ...
            // Standard Button (Existing Logic)
            actionBtn.className = isCompleted ? 'btn btn-secondary' : 'btn';
            actionBtn.innerHTML = isCompleted ? '<i class="fas fa-check"></i> Đã hoàn thành' : 'Hoàn thành bài học';
            if (isCompleted) {
    ...
    this.showToast(`Bắt đầu bài tập: ${step.title}`);
}
...
startMeditationSetup(goal) {
    ...
    if (this.meditationState.isExam) {
        ...
        // Calculate Avg Attention Score (Pro Score)
        // Weighted Sum: L1=4, L2=3, L3=2, L4=1
        let weightedSum = 0;
        let proCount = 0;
        this.meditationState.touches.forEach(t => {
            if (t.v) {
                weightedSum += (5 - t.v); // 1->4, 2->3, 3->2, 4->1
                proCount++;
            }
        });
        ...
        // CRITERIA
        // 1. Duration: Must be ~60 mins (allow 59 due to rounding)
        // 2. Quality > 50%
        // 3. Score >= 1.2
        // 4. Density >= 5
        // 5. Total Count > 500
        
        const passedDuration = minutes >= 59;
        const passedQuality = qualityPct >= 50;
        const passedScore = avgScore >= 1.2;
        const passedDensity = density >= 5;
        const passedCount = totalCount > 500;
        ...
        if (passed) {
            ...
            this.playBell(); // Victory sound
        } else {
            alert(`❌ KẾT QUẢ BÀI THI: KHÔNG ĐẠT\n\n` +
                  `- Thời gian: ${minutes}p (Yêu cầu 60p) ${passedDuration ? '✅':'❌'}\n` +
                  `- Chất lượng: ${qualityPct}% (Yêu cầu ≥ 50%) ${passedQuality ? '✅':'❌'}\n` +
                  `- Điểm chú tâm: ${avgScore.toFixed(2)} (Yêu cầu ≥ 1.2) ${passedScore ? '✅':'❌'}\n` +
                  `- Mật độ: ${density.toFixed(1)} (Yêu cầu ≥ 5) ${passedDensity ? '✅':'❌'}\n` +
                  `- Tổng số: ${totalCount} (Yêu cầu ≥ 500) ${passedCount ? '✅':'❌'}\n\n` +
...
calculateGoalTier(goal) {
    ...
    // 5. Determine Tier
    if (totalScore >= 0.9) return { id: 'diamond', name: 'Hạng Kim Cương', class: 'tier-diamond', icon: 'fab fa-sketch' };
    if (totalScore >= 0.75) return { id: 'gold', name: 'Hạng Vàng', class: 'tier-gold', icon: 'fas fa-jedi' };
    if (totalScore >= 0.5) return { id: 'silver', name: 'Hạng Bạc', class: 'tier-silver', icon: 'fab fa-ethereum' };
...
renderGoals() {
    ...
    sortedGoals.forEach(goal => {
        ...
        if (showBadge) {
            ...
            // Overwrite Tier for Certification
            const displayTier = isCertGoal ? { name: 'Chứng Chỉ Thiền Định', icon: 'fas fa-graduation-cap', class: 'tier-diamond' } : tier;
            ...
            if(isCertGoal) badgeDiv.style.border = "2px solid #ffd700"; // Gold border for cert
        ...
        if (isCertGoal && targetMet && !isCertified) {
             ...
             div.innerHTML = `
                ...
                <p style="color: var(--text-light); font-size: 13px; margin-bottom: 20px;">
                    Bạn đã hoàn thành 10,000 chánh niệm. Hãy vượt qua bài kiểm tra cuối cùng để nhận chứng chỉ.
                </p>
                ...
                <button class="btn" style="width: 100%; background: var(--warning); color: black; font-weight: bold;" onclick="app.startExamSession('${goal.id}')">
                    <i class="fas fa-play-circle"></i> Bắt đầu Thi (60p)
                </button>
             `;
             container.appendChild(div);
             return;
        ...
        if (dailyTarget > 0) {
            ...
            const sessionClick = isCertGoal ? `onclick="app.showToast('Không thể thay đổi mục tiêu chứng chỉ')"` : `onclick="app.setDailySessionTarget('${goal.id}')"`;
            ...
            if (isMeditation) {
                ...
                const minClick = isCertGoal ? `onclick="app.showToast('Không thể thay đổi mục tiêu chứng chỉ')"` : `onclick="app.setDailyMinMedTarget('${goal.id}')"`;
...
startExamSession(goalId) {
    ...
    this.meditationState = {
        ...
        startTime: Date.now(), 
        totalDurationSeconds: 60 * 60, // Fixed 60 mins
